      ...
      {props.title.map(place => (
        <div className="col-sm-md-auto card mx-4 my-3" style={{padding:"0px",margin:"0px"}}>
          <div className="card" style={{ width: "18rem" ,border: "0px",alignSelf:"center" }}>
            <img style={{ height: "20rem", width: "18rem", padding: "1rem" }} src="https://www.tridenthotels.com/content/gallery/f2.jpg" className="card-img-top" alt="" />
            <div className="card-body">
              <h5 className="card-title">{place.Hotel_name}</h5>
